/*
    GENERATOR PROGRAM FOR PROJECT 2
    TO BE USED FOR MAIN.CPP
 
    GROUP MEMBERS: Jose Salazar, Russell Price, Bryan Goforth, Sara Warren
 
 
    This program generates random data to be used as inputdata for our main program.
    Output meets the requirements for our simulator to complete its job.
 
    ******IMPORTANT********
    TO COMPILE THIS PROGRAM YOU MUST USE THE -std=c++0x FLAG
    ***********************
*/
